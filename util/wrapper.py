...
# Encoder
        ...
        self.encoderlib = ctypes.CDLL('/home/symlab/ahmad/VideoStream_over_RTSP-RTP/lib/encoder.so',mode=ctypes.RTLD_GLOBAL)
...
# Decoder
        ctypes.CDLL('/usr/lib/x86_64-linux-gnu/libvpx.so',mode=RTLD_GLOBAL)
        self.decoderlib = ctypes.CDLL('/home/symlab/ahmad/VideoStream_over_RTSP-RTP/lib/decoder.so',mode=ctypes.RTLD_GLOBAL)
# Dirty hack to pass string to the C code
